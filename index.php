...
<div class="content">
	...
	<form method="post" action="result.php" class="newurl">
		<div class="form-item full-width">
			<p><label for="url" class="primary"><?php yourls_e( 'Long URL (required):', 'isq_translation'); ?></label></p>
			<p><label for="url" class="secondary"><?php yourls_e( 'Paste the long URL here', 'isq_translation'); ?></label></p>
		...
		<div class="form-item half-width right">
			<p><label for="title" class="primary"><?php yourls_e( 'Optional title:', 'isq_translation'); ?></label></p>
		...
		<div class="form-item recaptcha-container">
			<p><label class="primary" title=""><?php yourls_e( 'reCAPTCHA:', 'isq_translation'); ?></label></p>
			<p><label class="secondary"><?php yourls_e( 'Verification used to ensure the user is not a bot', 'isq_translation'); ?></label></p>
